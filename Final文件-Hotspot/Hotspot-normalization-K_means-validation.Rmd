...
## Load library
Parameter change: at row 414(K-num iteration)，row 677,1006 (aplha for significance test),  827,1169 alp(alpha for high-mutation point test)
...
Kmin <- 40
Kmax <- 45
iteration <- 1 #iteration number per k num 
