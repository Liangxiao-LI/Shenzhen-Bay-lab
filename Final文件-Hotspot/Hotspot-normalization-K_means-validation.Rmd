...
check whether need normalizing xyz with virus percent.

```{r}

t.test(feature_vector[, 1], feature_vector[, 4])
t.test(feature_vector[, 2], feature_vector[, 4])
t.test(feature_vector[, 3], feature_vector[, 4])


```

Therefore no need to scale with virus percent again.
